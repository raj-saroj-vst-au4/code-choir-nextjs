const Login = () => {
  return (
    <section className="h-screen p-8 bg-gray-900 text-white">
            ...
            <form>
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
                  ...
                  <a
                    href="#!"
                    className="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700 ml-4 text-white"
                  >
                    Register
                  </a>
                </p>
